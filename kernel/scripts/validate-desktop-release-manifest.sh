...
github_base="https://github.com/esengine/DeepSeek-Tempora/releases/download/${expected_tag}/"
...
jq -e \
	...
	(if $legacy and (.downloads == null)
		then true
			...
			(.downloads["Tempora-windows-amd64.zip"] | valid_asset("Tempora-windows-amd64.zip"))
	end)
' "$manifest" >/dev/null
