...
All eight official Tempora themes ship with **original** artwork generated procedurally
...
Assets are released under the MIT License as part of the Tempora repository,
© Tempora Contributors. Human review: Tempora Contributors (release PR review).
