...
func TestProviderConfigured(t *testing.T) {
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "TEMPORA_TEST_KEY", resolvedAPIKey: "secret"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "TEMPORA_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "TEMPORA_TEST_MISSING"}, false},
		{"loopback key env unset", ProviderEntry{BaseURL: "http://127.0.0.1:23333/v1", APIKeyEnv: "TEMPORA_TEST_MISSING"}, true},
