...
func TestManagedConfigWriteApprovalIsFreshHuman(t *testing.T) {
	...
	subject := "write Tempora config: /home/u/.tempora/config.toml"
	...
	if !a.preApprovedForDecision(ManagedConfigWriteApprovalTool, "write Tempora config: /other/path", nil, true) {
