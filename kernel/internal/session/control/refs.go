...
const (
	...
	refImage                   // a local image attachment: @.tempora/attachments/<file>
)
...
const externalFolderRefPrefix = "__tempora_external_folder"
...
// text rather than a Tempora slash command.
