...
func Collect(opts Options) Report {
	...
	skillsR, skillIssues := collectSkills(root, home, temporaHome, cfg, disp)
...
func collectSkills(root, home, temporaHome string, cfg *config.Config, disp func(string) string) (AssetReport, []Issue) {
	var issues []Issue
