...
var DocumentNames = []string{"TEMPORA.md", "AGENTS.md", "CLAUDE.md"}
var LocalDocumentNames = []string{"TEMPORA.local.md", "AGENTS.local.md", "CLAUDE.local.md"}
...
func Resolve(opts ResolveOptions) Resolution {
	...
	// import (@TEMPORA.md from both AGENTS.md and CLAUDE.md) contributes its
...
func userInstructionImportRoots(userDir string) []string {
	...
	if home, err := os.UserHomeDir(); err == nil && strings.TrimSpace(home) != "" {
		for _, name := range []string{".tempora", ".agents", ".agent", ".claude"} {
