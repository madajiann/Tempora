// Package memory implements Tempora's persistent memory. It mirrors Claude
// Code's two-layer model while honoring Tempora's cache-first architecture:
//
//   - Standing instructions resolved by internal/state/instruction and exposed here
...
const (
	ScopeUser     = instruction.ScopeUser     // ~/.tempora/TEMPORA.md
...
// TEMPORA.md is ours; AGENTS.md and CLAUDE.md are the cross-tool conventions.
