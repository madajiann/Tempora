...
func TestDisableDiscoveryReturnsEmptyStore(t *testing.T) {
	...
	writeSkill(t, home, ".tempora/skills/global.md", "---\ndescription: global\n---\nbody")
	writeSkill(t, project, ".tempora/skills/project.md", "---\ndescription: project\n---\nbody")
...
func TestListPrecedenceProjectOverGlobal(t *testing.T) {
	...
	writeSkill(t, proj, ".tempora/skills/greet.md", "---\nname: greet\ndescription: project greet\n---\nproject body")
	writeSkill(t, home, ".tempora/skills/greet.md", "---\ndescription: global greet\n---\nglobal body")
	writeSkill(t, home, ".tempora/skills/onlyglobal.md", "---\ndescription: only global\n---\nbody")
...
func TestPluginSkillShortAliasIsHiddenAndProjectSkillKeepsShortName(t *testing.T) {
	...
	writeSkill(t, project, ".tempora/skills/plan/SKILL.md", "---\ndescription: project plan\n---\nPROJECT")
...
func TestFlatAndDirLayout(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/flat.md", "---\ndescription: flat\n---\nflat body")
	writeSkill(t, home, ".tempora/skills/dir/SKILL.md", "---\ndescription: dir\n---\ndir body")
...
func TestNestedSkillsDiscoveredByDefault(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/superpower/skill-a.md", "---\ndescription: nested flat\n---\nflat body")
	writeSkill(t, home, ".tempora/skills/superpower/tool-a/SKILL.md", "---\ndescription: nested dir\n---\ndir body")
	writeSkill(t, home, ".tempora/skills/superpower/references/notes.md", "---\ndescription: not a skill\n---\nnotes")
...
func TestNestedSkillsRequireDescription(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/root.md", "---\n---\nroot body")
	writeSkill(t, home, ".tempora/skills/superpower/draft.md", "---\n---\ndraft body")
	writeSkill(t, home, ".tempora/skills/superpower/tool/SKILL.md", "---\n---\ntool body")
...
func TestNestedDirectorySkillStopsTraversal(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/pack/SKILL.md", "---\ndescription: pack\n---\npack body")
	writeSkill(t, home, ".tempora/skills/pack/child.md", "---\ndescription: child\n---\nchild body")
...
func TestTemporaHomeDirOverridesGlobalTemporaSkills(t *testing.T) {
	home := testenv.TempDir(t)
	temporaHome := filepath.Join(testenv.TempDir(t), "rx-home")
	writeSkill(t, home, ".tempora/skills/old.md", "---\ndescription: old\n---\nold")
	writeSkill(t, home, ".tempora/skills/current.md", "---\ndescription: old current\n---\nold current")
	currentPath := writeSkill(t, temporaHome, "skills/current.md", "---\ndescription: current\n---\ncurrent")

	st := New(Options{HomeDir: home, TemporaHomeDir: temporaHome, DisableBuiltins: true})
	list := st.List()
	current, ok := find(list, "current")
	if !ok {
		t.Fatal("Tempora home skill should be discovered")
	}
	if current.Path != currentPath {
		t.Fatalf("current skill path = %q, want Tempora home path %q", current.Path, currentPath)
	}
	if _, ok := find(list, "old"); !ok {
		t.Fatal("legacy ~/.tempora skill should remain discoverable")
	}
	...
	want := filepath.Join(temporaHome, SkillsDirname, "created", SkillFile)
	if path != want {
...
func TestExcludedPathsHideConventionRoots(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/keep.md", "---\ndescription: keep\n---\nb")
...
func TestFrontmatterFields(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/sub.md",
		"---\ndescription: a sub\nrunAs: subagent\nallowed-tools: read_file, grep\nmodel: deepseek-pro\nread-only: true\n---\nbody")
	writeSkill(t, home, ".tempora/skills/fork.md", "---\ndescription: f\ncontext: fork\n---\nbody")
	writeSkill(t, home, ".tempora/skills/plain.md", "---\ndescription: p\n---\nbody")
...
func TestReferencesInlined(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/withrefs/SKILL.md", "---\ndescription: r\n---\nmain body")
	writeSkill(t, home, ".tempora/skills/withrefs/references/b.md", "second ref")
	writeSkill(t, home, ".tempora/skills/withrefs/references/a.md", "first ref")
...
func TestScriptsAppended(t *testing.T) {
	...
	writeSkill(t, home, ".tempora/skills/withscripts/SKILL.md", "---\ndescription: r\n---\nmain body")
	writeScript(t, home, ".tempora/skills/withscripts/scripts/lint.py", "#!/usr/bin/env python3\nprint('ok')")
	writeScript(t, home, ".tempora/skills/withscripts/scripts/deploy.sh", "#!/usr/bin/env bash\necho ok")
...
func TestNoScriptsWhenDirAbsent(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/noscripts/SKILL.md", "---\ndescription: r\n---\nmain body")
	st := New(Options{HomeDir: home, DisableBuiltins: true})
...
func TestScriptsFilteredByExt(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/scriptscheck/SKILL.md", "---\ndescription: t\n---\nbody")
	writeScript(t, home, ".tempora/skills/scriptscheck/scripts/lint.py", "#!/usr/bin/env python3\nprint('ok')\n")
	writeScript(t, home, ".tempora/skills/scriptscheck/scripts/.hidden.py", "")
	writeScript(t, home, ".tempora/skills/scriptscheck/scripts/readme.md", "# readme")
	writeScript(t, home, ".tempora/skills/scriptscheck/scripts/deploy", "#!/bin/sh\necho ok")
	writeScript(t, home, ".tempora/skills/scriptscheck/scripts/legacy.p", "print 'ok'\n")
	writeScript(t, home, ".tempora/skills/scriptscheck/scripts/.gitkeep", "")
...
func TestBuiltinsPresentAndOverridable(t *testing.T) {
	...
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/explore.md", "---\ndescription: mine\nrunAs: inline\n---\nbody")
...
func TestDisabledSkillsAreFilteredFromListAndRead(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/active.md", "---\ndescription: active\n---\nbody")
	writeSkill(t, home, ".tempora/skills/hidden.md", "---\ndescription: hidden\n---\nbody")
...
func TestInvalidNamesSkipped(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/bad name.md", "---\ndescription: x\n---\nb") // space → invalid
	st := New(Options{HomeDir: home, DisableBuiltins: true})
	if len(st.List()) != 0 {
...
func TestSymlinkedDirAndFile(t *testing.T) {
	...
	skillsRoot := filepath.Join(home, ".tempora", "skills")
...
func TestColorFrontmatterParses(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/tagged.md", "---\ndescription: has a color\ncolor: amber\n---\nbody")
...
func TestManualInvocationSkillExcludedFromIndex(t *testing.T) {
	home := testenv.TempDir(t)
	writeSkill(t, home, ".tempora/skills/private-agent.md", "---\ndescription: my private subagent\nrunAs: subagent\ninvocation: manual\n---\nbody")
	writeSkill(t, home, ".tempora/skills/public-agent.md", "---\ndescription: a discoverable subagent\nrunAs: subagent\n---\nbody")
...
func TestCreateRefusesOverwrite(t *testing.T) {
	...
	if !strings.HasSuffix(path, filepath.Join(".tempora", "skills", "mine", SkillFile)) {
	...
	writeSkill(t, home, ".tempora/skills/legacy.md", "---\ndescription: legacy\n---\nbody")
