...
// Run with:
//
//	TEMPORA_LIVE_CHROME_MCP=1 go test ./internal/ext/plugin \
...
func TestChromeDevtoolsMCPLive(t *testing.T) {
	...
	out = executeLiveChromeTool(t, callCtx, tools, "wait_for", map[string]any{"text": []string{"Tempora MCP Ready"}, "timeout": 10_000})
