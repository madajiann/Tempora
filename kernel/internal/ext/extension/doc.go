...
// lives in the existing packages (internal/ext/skill, internal/ext/command,
// internal/ext/hook, internal/contract/tool, internal/ext/plugin, internal/contract/provider), which
...
// a package's prompts are found with its commands, and internal/ext/theme reads
