...
// (<Tempora home>/plugin-packages.json) AND currently enabled. The launch
...
//
// FULL-TRUST CONTRACT: a sidecar process inherits the UNFILTERED Tempora
// environment (os.Environ), plus its manifest env and TEMPORA_PLUGIN_ROOT /
// TEMPORA_PLUGIN_NAME / TEMPORA_PLUGIN_VERSION. Sidecars can read
