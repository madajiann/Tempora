...
// credential-free public copies. Conversion to and from internal/contract/provider
// types lives host-side in a later stage; these DTOs deliberately do not
// import internal/contract/provider so the public wire schema stays self-contained.
...
// fields only, no Tempora-local display metadata.
