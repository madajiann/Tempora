...
// the Tempora host and out-of-process extension sidecars. It is a public
// protocol: sidecars are written against this package's generated JSON Schema
// and its compatibility hash, not against Tempora internals.
//
...
//
// The sidecar process is the "extension" peer; Tempora is the "host" peer.
// Directions are named from the host's point of view: host_to_extension_*
// flows from Tempora to the sidecar, extension_to_host_* flows back.
package protocol
...
const ProtocolID = "tempora.extension.v2"
