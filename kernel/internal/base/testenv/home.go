...
// IsolateUserState redirects default user-scoped Tempora paths to a disposable
...
func IsolateUserState() (func(), error) {
	...
	home, err := os.MkdirTemp(originalHome, ".tempora-test-home-*")
	if err != nil && originalHome != "" {
		home, err = os.MkdirTemp("", "tempora-test-home-*")
	}
	if err != nil {
