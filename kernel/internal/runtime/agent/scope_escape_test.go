...
func TestMutationOutsideThePlanEscapes(t *testing.T) {
	...
	if a.mutationEscapesPlan("write_file", writeArgs("internal/model/billing/invoice.go")) != true {
...
func TestCandidatePathsCountAsScope(t *testing.T) {
	...
	if a.mutationEscapesPlan("write_file", writeArgs("internal/assembly/boot/boot.go")) {
