...
func TestSubagentStoreCleanupStaleRunningSkipsForeignLiveParent(t *testing.T) {
	...
	cmd.Env = append(os.Environ(),
		"TEMPORA_SUBAGENT_LEASE_HELPER=1",
		"TEMPORA_SUBAGENT_LEASE_PATH="+parentPath,
	)
...
func TestSubagentStoreForeignLeaseHelper(t *testing.T) {
	if os.Getenv("TEMPORA_SUBAGENT_LEASE_HELPER") != "1" {
		return
	}
	lease, err := sessionstore.TryAcquireSessionLease(os.Getenv("TEMPORA_SUBAGENT_LEASE_PATH"))
	if err != nil {
