...
// Command tempora-update-helper (Linux) installs a verified .deb under Polkit.
...
var packageName = "tempora-desktop"
...
const (
	...
	phasePrefix = "TEMPORA_UPDATE_PHASE="
)
...
func realDeps() installDeps {
	return installDeps{
		geteuid:          os.Geteuid,
		getenv:           os.Getenv,
		mkTempDir:        func() (string, error) { return os.MkdirTemp("", "tempora-update-*") },
