...
func TestGenManifest(t *testing.T) {
	...
	t.Setenv("GITHUB_REPOSITORY", "esengine/tempora")
	...
	wantURL := "https://github.com/esengine/DeepSeek-Tempora/releases/download/desktop-v1.2.0/Tempora-windows-amd64-installer.exe"
	if win.URL != wantURL {
