// Shared page shell + UI kit. Visual language mirrors the tempora.io website:
...
<header><a class="brand" href="https://tempora.io">${LOGO}</a><a class="brand" href="https://tempora.io">Tempora</a><span class="crumb">/ ${esc(crumb)}</span>${LANG_SWITCH}${nav ? `<span class="nav">${nav}</span>` : ""}</header>
