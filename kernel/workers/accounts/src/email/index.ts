...
export function verifyEmail(link: string): Omit<EmailMessage, "to"> {
  return {
    subject: "Confirm your Tempora email",
    text: `Welcome to Tempora! Confirm your email to activate your account:\n\n${link}\n\nThis link expires in 24 hours. If you didn't sign up, ignore this email.`,
    html: layout(
      "Confirm your email",
      "Welcome to Tempora! Confirm your email address to activate your account. This link expires in 24 hours.",
      "Confirm email",
      link,
...
export function resetEmail(link: string): Omit<EmailMessage, "to"> {
  return {
    subject: "Reset your Tempora password",
    text: `Someone requested a password reset for your Tempora account. Set a new password here:\n\n${link}\n\nThis link expires in 1 hour. If it wasn't you, you can safely ignore this email.`,
    html: layout(
      "Reset your password",
      "Someone requested a password reset for your Tempora account. This link expires in 1 hour. If it wasn't you, ignore this email.",
      "Reset password",
      link,
      `Or paste this link: ${link}`,
    ),
...
export function accountExistsEmail(loginUrl: string, resetUrl: string): Omit<EmailMessage, "to"> {
  return {
    subject: "You already have a Tempora account",
