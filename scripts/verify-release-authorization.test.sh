...
export ACTUAL_CALLER_WORKFLOW_REF='example/tempora/.github/workflows/release-candidate.yml@refs/heads/main-v2'
...
refuse CALLER_EVENT_NAME=push ACTUAL_CALLER_WORKFLOW_REF='example/tempora/.github/workflows/other.yml@refs/heads/main-v2'
refuse CALLER_EVENT_NAME=push \
	ACTUAL_CALLER_WORKFLOW_REF='example/tempora/.github/workflows/release-promote.yml@refs/heads/main-v2' \
	EXPECTED_CALLER_WORKFLOW_REF='example/tempora/.github/workflows/release-promote.yml@refs/heads/main-v2'
