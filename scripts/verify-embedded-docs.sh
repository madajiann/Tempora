...
ldflags="-s -w -X main.version=$version -X main.gitCommit=$git_commit -X main.buildTimeUTC=$build_time_utc -X tempora/internal/productdocs.linkedVersion=$version -X tempora/internal/productdocs.linkedRevision=$revision"
(
	cd "$repo_root"
