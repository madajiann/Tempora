...
export function validateReleaseEvent(event, release) {
  ...
  invariant(event.releaseNotesUrl === `https://tempora.io/changelog/v${release.version}/`, "release event URL is invalid");
...
async function main() {
  ...
  if (args.command === "generate") {
    ...
    const event = validateReleaseEvent({
      ...
      releaseNotesUrl: `https://tempora.io/changelog/v${release.version}/`,
