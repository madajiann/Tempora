...
def main():
    ...
    en.append("All eight official Tempora themes ship with **original** artwork generated procedurally")
    ...
    en.append("Assets are released under the MIT License as part of the Tempora repository,")
    en.append("© Tempora Contributors. Human review: Tempora Contributors (release PR review).\n")
    ...
    zh.append("八款 Tempora 官方主题的全部图片均为**原创**，由 `scripts/official-theme-art/` 中的脚本")
    ...
    zh.append("素材随 Tempora 仓库以 MIT 许可发布，© Tempora Contributors。人工审核：Tempora Contributors（发布 PR 审核）。\n")
