...
export const npmPackages = [
  "tempora", "tempora-cli-darwin-arm64", "tempora-cli-darwin-x64",
...
function requirePayloadLayout(root, files) {
  ...
  const cli = [
    "tempora-darwin-amd64.tar.gz", "tempora-darwin-arm64.tar.gz",
    "tempora-linux-amd64.tar.gz", "tempora-linux-arm64.tar.gz",
    "tempora-windows-amd64.zip", "tempora-windows-arm64.zip", "SHA256SUMS",
    "tempora.rb",
  ];
