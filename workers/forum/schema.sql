-- Tempora Community forum. Identity comes from id.tempora.io; this DB holds
-- forum content plus the anti-abuse state (trust levels, flags, silences).
-- Apply: wrangler d1 execute tempora-forum --remote --file=schema.sql
...
CREATE TABLE IF NOT EXISTS members (
  email          TEXT PRIMARY KEY,              -- lowercased id.tempora.io identity
