-- Unify dashboard auth onto id.tempora.io: dashboard access is now a per-email
...
-- Apply: wrangler d1 execute tempora-crash --remote --file=migrate-access.sql
...
-- admins/viewers keep their access when they next sign in via id.tempora.io.
