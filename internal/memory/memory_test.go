...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/TEMPORA.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "TEMPORA.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "TEMPORA.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "TEMPORA.local.md"), "LOCAL LEVEL")
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "TEMPORA.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportResolutionRejectsEscapes(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "TEMPORA.md"), "Top\n@/abs/path.md\n@~/secret.md\n@../secret.md\nBottom")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "TEMPORA.md"), "@a.md")
...
func TestImportDiamondAndCycle(t *testing.T) {
	...
	mustWrite(t, filepath.Join(projCycle, "TEMPORA.md"), "@cycle1.md")
...
func TestLoadHidesMemoryUnderExperimentEnv(t *testing.T) {
	...
	t.Setenv("TEMPORA_EXPERIMENT_NO_MEMORY", "1")
	set := Load(Options{CWD: proj, UserDir: user})
