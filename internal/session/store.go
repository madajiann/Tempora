// Package session owns Tempora's canonical session service.
//
...
const (
	...
	Codec             = V4Codec
	FinalV31Codec     = "tempora.session.linear/v3.1"
	LegacyLinearCodec = "tempora.session.linear/v3"
	PrototypeCodec    = "tempora.session.events/v3"
