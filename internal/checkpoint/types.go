...
// FileRevision is the v2 per-file preimage plus last Tempora-owned after fingerprint.
type FileRevision struct {
	...
	// AfterSHA256 is the fingerprint of the file after the last Tempora-owned write.
