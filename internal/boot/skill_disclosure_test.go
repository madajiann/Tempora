...
`)
	...
	prov := testutil.NewMock("skill-disclosure",
		...
		testutil.Turn{ToolCalls: []provider.ToolCall{{ID: "guide", Name: "use_capability",
			Arguments: `{"action":"call","capability_id":"tool:read_skill","arguments":{"name":"tempora-guide"}}`}}},
		testutil.Turn{ToolCalls: []provider.ToolCall{{ID: "page", Name: "use_capability",
			Arguments: `{"action":"call","capability_id":"tool:read_skill","arguments":{"name":"tempora-guide","reference":"references/hooks.md"}}`}}},
