...
func TestBootStableExtensionCacheGuard(t *testing.T) {
	...
	t.Chdir(dir)
	writeRuntimeFixture(t, dir)
	installBootFakePlugin(t, config.TemporaHomeDir(), "stable-strategist", map[string]any{
		"replaces": []string{"system_prompt"},
...
func TestBootSystemPromptStrategyFailureFailsBuild(t *testing.T) {
	t.Run("block", func(t *testing.T) {
		...
		t.Chdir(dir)
		writeRuntimeFixture(t, dir)
		installBootFakePlugin(t, config.TemporaHomeDir(), "blocker", map[string]any{
			"replaces": []string{"system_prompt"},
	...
	t.Run("contract violation", func(t *testing.T) {
		...
		t.Chdir(dir)
		writeRuntimeFixture(t, dir)
		installBootFakePlugin(t, config.TemporaHomeDir(), "violator", map[string]any{
			"replaces": []string{"system_prompt"},
