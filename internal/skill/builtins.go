...
Find existing AGENTS.md, TEMPORA.md, or CLAUDE.md and follow their imports to the authoritative document. Preserve thin wrappers and unrelated user guidance; update the owning file rather than creating a competing instruction source. Use AGENTS.md for a new project with no existing instruction document.
...
func builtinSkills() []Skill {
	...
	base := []Skill{
		...
		},
		{
			...
			Description: "Install or uninstall Tempora skills and MCP servers through install_source plans.",
