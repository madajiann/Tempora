...
func TestValidateTrustedSessionPath(t *testing.T) {
	cases := []struct {
		...
		{"absolute posix path", "/home/u/.tempora/sessions/abc.jsonl", false},
		{"absolute windows path", `C:\Users\me\.tempora\sessions\abc.jsonl`, false},
		{"workspace-relative", "sessions/abc.jsonl", false},
		// Filenames with a hidden segment are still legitimate.
		{"..hidden is allowed", "/home/u/.tempora/..hidden.jsonl", false},
