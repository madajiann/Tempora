...
// #4218: pre-v1.11 persistence paths full-rendered ./tempora.toml and pinned
...
`)
	...
	project := t.TempDir()
	writeProjectDefaultTestConfig(t, project, "tempora.toml", `default_model = "deepseek-flash"
...
`)
	...
	project := t.TempDir()
	writeProjectDefaultTestConfig(t, project, "tempora.toml", `default_model = "local"
`)
...
`)
	...
	project := t.TempDir()
	writeProjectDefaultTestConfig(t, project, "tempora.toml", `default_model = "gone"
`)
...
func TestLoadForRoot_NoUserConfigKeepsBrokenProjectDefaultModel(t *testing.T) {
	...
	project := t.TempDir()
	writeProjectDefaultTestConfig(t, project, "tempora.toml", `default_model = "legacy-missing"
