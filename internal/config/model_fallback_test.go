...
func testModelFallbackConfig(t *testing.T) *Config {
	...
	c.Providers = []ProviderEntry{
		{Name: "prov-a", Kind: "openai", BaseURL: "https://a.example.com", Model: "model-a1", Models: []string{"model-a1", "model-a2"}, APIKeyEnv: "TEMPORA_TEST_KEY", resolvedAPIKey: "sk-test"},
		{Name: "prov-b", Kind: "openai", BaseURL: "https://b.example.com", Model: "model-b1", Models: []string{"model-b1", "model-b2"}, APIKeyEnv: "TEMPORA_TEST_KEY", resolvedAPIKey: "sk-test"},
		{Name: "prov-nokey", Kind: "openai", BaseURL: "https://nk.example.com", Model: "model-nk", APIKeyEnv: "TEMPORA_TEST_EMPTY"},
	}
	return c
}
...
func TestResolveModelWithFallbackSkipsKeylessProvider(t *testing.T) {
	...
	c.Providers[0].APIKeyEnv = "TEMPORA_TEST_EMPTY"
...
func TestResolveModelWithFallbackHonorsDefaultModel(t *testing.T) {
	...
	c.Providers[1].APIKeyEnv = "TEMPORA_TEST_EMPTY" // prov-b, the DefaultModel
...
func TestRemoveProviderBlocksDefaultWithoutFallback(t *testing.T) {
	...
	c.Providers[1].APIKeyEnv = "TEMPORA_TEST_EMPTY"
	c.Providers[1].resolvedAPIKey = ""
