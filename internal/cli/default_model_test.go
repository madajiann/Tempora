...
const (
	defaultModelTestConfiguredEnv = "TEMPORA_CLI_TEST_CONFIGURED_KEY"
	defaultModelTestKeylessEnv    = "TEMPORA_CLI_TEST_KEYLESS_KEY"
)
...
// setCredential writes a "configured" sentinel key into Tempora's user
