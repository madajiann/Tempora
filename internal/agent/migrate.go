...
// previous ~/.tempora import marker cannot hide sessions from a redirected
...
func migrateLegacySessionsWithMarkers(srcDir, globalDest, marker, jsonlMarker string, projectDir func(string) string) (int, error) {
	...
	// (e.g. Users_Yuki_git_polytone-audio-engine/ under ~/.tempora/sessions/).
...
// portable across the filesystems Tempora supports.
