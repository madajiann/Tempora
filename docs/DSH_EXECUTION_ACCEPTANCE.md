...
Acceptance baseline: Tempora `main-v2@986a6bc967`; behavioral reference: DeepSeek Harness `master@c291e7961a`. Validation date: 2026-09-13.
...
publication). Tempora retains its Go execution, encoding, and buffer adapters.
