...
实现参考本地 DeepSeek Harness `c291e7961a515f6d7af9304e7fd1d257929aef26` 的聊天内容组织和交互方式。Tempora 保留自己的会话协议、`present` 工具、权限体系、资源读取接口和 Electron 工作台，没有复制 Cordis 或 Harness 的整个 Conversation 框架。
