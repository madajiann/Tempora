...
English overview of the Tempora plugin/runtime v2 model. Chinese: [EXTENSION_RUNTIME_V2.zh-CN.md](./EXTENSION_RUNTIME_V2.zh-CN.md).

## Protocol and manifest

- Plugin manifest: exact `apiVersion: tempora.io/plugin/v2` only (no `v2.0`/`v2.1` aliases; v1 and legacy native rejected).
- Compatibility boundary: no v1 dual-read or automatic migration. Extension
  ...
  runtime manifest.
- Extension wire protocol: `tempora.extension.v2` (major 2).
