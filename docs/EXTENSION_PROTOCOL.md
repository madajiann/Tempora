# Tempora Extension Protocol v2

The Extension Protocol is the stable wire contract between Tempora (the
...
A code extension is **full trust**: it runs outside the Tempora sandbox
