...
Tempora keeps the Go runtime, v4 physical log, SQLite projections and Desktop
...
Final tested ZIP: `dist/Tempora-darwin-arm64.zip`, version
...
Tested archive: `dist/Tempora-windows-arm64.zip`, version
