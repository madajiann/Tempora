...
Ported from DeepSeek Harness c291e7961a into the existing Tempora scroll controller.
...
Installed: `~/Applications/Tempora-Canary/Tempora.app`

Profile: `~/Library/Application Support/Tempora-Test-ChatRefactor`
