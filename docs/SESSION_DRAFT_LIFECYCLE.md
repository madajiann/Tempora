...
Tempora Desktop treats a manually opened local conversation as an editor draft
...
Draft state is stored in `desktop/drafts-v1.sqlite` under the Tempora user state
