...
const remoteForkUnsupported = "this remote Tempora Serve does not support " + serveCapabilitySessionForkTargetsV1 + "; upgrade it to fork a remote turn into an independent session"
