...
const SIDEBAR_COLLAPSED_KEY = "tempora.sidebar.collapsed";
...
const WORKSPACE_PANEL_OPEN_KEY = "tempora.workspacePanel.open";
...
const TERMINAL_PANEL_OPEN_KEY = "tempora.terminalPanel.open";
...
const TERMINAL_HEIGHT_KEY = "tempora.terminalPanel.height";
