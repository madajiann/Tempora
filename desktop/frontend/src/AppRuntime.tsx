...
export function AppRuntime() {
  ...
  useEffect(() => {
    ...
    const showCleanupNotice = (status: LegacyEmptySessionCleanupStatus) => {
      ...
      const storageKey = `tempora.legacy-empty-session-cleanup.notice.${status.batchId}`;
      let shown = false;
      try {
