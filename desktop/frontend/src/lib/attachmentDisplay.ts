...
const attachmentRefRe = /@(\.tempora\/attachments\/[^\s]+)/g;
...
function isDisplayReference(path: string): boolean {
  if (path.startsWith("draft:") || path.startsWith("attachment:")) return true;
  if (path.startsWith(".tempora/attachments/")) return true;
...
function displayAttachment(path: string, name: string): DisplayAttachment {
  if (path.startsWith("draft:") || path.startsWith("attachment:") || path.startsWith(".tempora/attachments/")) {
