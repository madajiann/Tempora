...
const configWriteEnglishSubjectPrefix = "write Tempora config: ";
...
function localizeApprovalReason(tool: string, reason: string | undefined, t: Translator): string {
  ...
  if (tool === "config_write") {
    localized = !trimmed || trimmed.includes("Tempora-managed configuration file") ? t("approval.configWriteReason") : trimmed;
  }
  if (tool === "sandbox_escape") {
