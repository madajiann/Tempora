...
if (localStorage.getItem("tempora-model-favorites-v1") !== JSON.stringify(["z/shared"])) {
  throw new Error(`favorite ref was not persisted: ${localStorage.getItem("tempora-model-favorites-v1")}`);
}
