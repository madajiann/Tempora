...
const dialog = document.querySelector<HTMLElement>(".tempora-confirm-dialog");
const cancelButton = Array.from(document.querySelectorAll<HTMLButtonElement>(".tempora-confirm-dialog button"))
  .find((button) => button.textContent === "Cancel");
const deleteButton = Array.from(document.querySelectorAll<HTMLButtonElement>(".tempora-confirm-dialog button"))
...
ok(document.querySelector(".tempora-confirm-dialog") === null, "Escape cancels and closes the dialog");
...
const secondDeleteButton = Array.from(document.querySelectorAll<HTMLButtonElement>(".tempora-confirm-dialog button"))
  .find((button) => button.textContent === "Delete");
await act(async () => {
