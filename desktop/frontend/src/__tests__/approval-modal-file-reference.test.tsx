...

{
  ...
  const { root } = await renderApproval({
    approval: {
      ...
      reason: "This bash command is not in Tempora's built-in read-only set. Confirm only if this exact prefix is read-only for planning and research. Permission presets cannot answer this trust prompt.",
    },
  });
