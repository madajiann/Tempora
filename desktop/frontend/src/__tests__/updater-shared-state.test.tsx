...
ok(classifyUpdateError('update: fetch manifest: https://dl.tempora.io/latest/latest.json: platforms darwin-arm64 asset: unsupported install_layout "electron-v1" (keeping current version)') === "manual", "install layout boundaries prefer the official download");
