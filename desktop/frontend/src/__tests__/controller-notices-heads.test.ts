...
const cases: Array<[string, string, string]> = [
  ["session_concurrent_writer", "another writer appended to this session log", "Another Tempora window or process added to this conversation. Its content is kept as a separate version; use View versions to switch."],
