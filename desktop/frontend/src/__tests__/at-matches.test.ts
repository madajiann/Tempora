...
{
  const entries: DirEntry[] = [];
  const searchEntries = [externalEntry("__tempora_external_folder/abc/Folder/src/outside.txt", "Folder With Spaces/src/outside.txt")];
  const got = filterAtMatches(entries, searchEntries, "spaces");
  eq(
    got.map((e) => e.path),
    ["__tempora_external_folder/abc/Folder/src/outside.txt"],
...
{
  const entries = [externalEntry("__tempora_external_folder/abc/Folder/src/outside.txt", "outside.txt")];
  const searchEntries = [externalEntry("__tempora_external_folder/abc/Folder/src/outside.txt", "Folder With Spaces/src/outside.txt")];
