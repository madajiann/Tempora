...
const localOnlyDupes = toolItems([
  ...
  { role: "tool", toolCallId: "__tempora_local_only__", toolName: "__tempora_local_only__", content: "partial one" },
  { role: "user", content: "second" },
  { role: "tool", toolCallId: "__tempora_local_only__", toolName: "__tempora_local_only__", content: "partial two" },
] as HistoryMessage[]);
...
eq(
  ...
  true,
  "repeated __tempora_local_only__ toolCallIds uniquify so transcript row keys cannot collide after restart",
);
