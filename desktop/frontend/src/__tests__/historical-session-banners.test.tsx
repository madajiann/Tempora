...
await act(async () => document.getElementById("tempora-prepare-restored-session")!.click());
...
assert.equal(document.getElementById("tempora-prepare-restored-session"), null, "successful activation removes the preparation action");
