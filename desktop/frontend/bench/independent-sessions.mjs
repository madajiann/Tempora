...
const port = Number(process.env.TEMPORA_INDEPENDENT_BROWSER_PORT ?? 4687);
...
const evidence = process.env.TEMPORA_INDEPENDENT_EVIDENCE ?? path.join(tmpdir(), "tempora-independent-browser");
