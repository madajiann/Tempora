...
const MEMORY_PROTOCOL = memoryProtocol(process.env.TEMPORA_APP_MEMORY_PROFILE ?? "full");
const CYCLES = integerEnv("TEMPORA_APP_MEMORY_CYCLES", MEMORY_PROTOCOL.cycles);
const MIXED_CYCLES = integerEnv("TEMPORA_APP_MEMORY_MIXED_CYCLES", MEMORY_PROTOCOL.mixedCycles);
...
const PROCESSES = SHARD === null ? integerEnv("TEMPORA_APP_MEMORY_PROCESSES", MEMORY_PROTOCOL.shards) : 1;
