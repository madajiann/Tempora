...
const port = Number(process.env.TEMPORA_HISTORICAL_IMPORT_PORT ?? 4691);
...
try {
  ...
  await page.screenshot({ path: process.env.TEMPORA_HISTORICAL_IMPORT_EVIDENCE ?? path.join(root, "..", "..", "artifacts", "historical-import-browser.png") });
