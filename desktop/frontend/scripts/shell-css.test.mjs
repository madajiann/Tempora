...
test("electron keeps chrome no-drag but does not punch the titlebar with transcript boxes", () => {
  const css = [
    ".topicbar{--tempora-draggable:drag}",
    ".topicbar button{--tempora-draggable:no-drag}",
    ".topicbar__title-edit{--tempora-draggable:no-drag}",
    ".topicbar__title-input{--tempora-draggable:no-drag}",
    ".msg{--tempora-draggable:no-drag}",
    ".reasoning__head{-webkit-app-region:no-drag}",
    ".tool__head{-webkit-app-region:no-drag}",
    ".management-screen{--tempora-draggable:no-drag}",
    ".settings-modal-backdrop{--tempora-draggable:no-drag}",
    ".workbench-dock__tools{--tempora-draggable:no-drag}",
  ].join("");
...
test("chrome selector does not match unrelated topicbar or topbar class names", () => {
  const css = ".topicbarfoo{--tempora-draggable:no-drag}.topbar2{--tempora-draggable:no-drag}";
  const out = rewriteDragRegions(css, "electron");
