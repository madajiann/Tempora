...
// importThemePackZIP validates and extracts a .tempora-theme ZIP into a staging dir.
...
func extractThemeZip(zr *zip.Reader) (*ThemePackManifest, string, error) {
	...
	staging, err := os.MkdirTemp("", "tempora-theme-import-*")
	if err != nil {
		return nil, "", err
	}
	cleanup := true
...
// scanThemeZipEntries validates the container shape every .tempora-theme ZIP
