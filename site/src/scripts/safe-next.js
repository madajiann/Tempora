...
// under tempora.io. That lets a subdomain (e.g. crash.tempora.io) return
...
export function safeNext(next, origin) {
  ...
  if (u.protocol === "https:" && (u.host === "tempora.io" || u.host.endsWith(".tempora.io"))) return u.href;
  return null;
}
