...
export function downloadPaneFromURL(input, base = "https://tempora.io/") {
  let url;
  try {
...
export function releaseChannelFromURL(input, base = "https://tempora.io/") {
  let url;
  try {
    url = new URL(input, base);
  } catch {
...
export function downloadURLForPane(input, pane, channel, base = "https://tempora.io/") {
